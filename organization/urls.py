...
from organization.views import (organization_create, organization_profile, organization_update, organization_delete,
                                ...
                                employees_list, employee_update, employee_delete, event_profile, record_create,
                                records_list, record_update, record_delete, form_create_employee, employee_profile,
                                form_update_employee, form_update_event, form_create_event, form_create_organization,
                                form_update_organization, form_create_record, form_update_record)
...
record_urlpatterns = [
    ...
    path('list/<int:pk>', records_list, name='records_list'),
