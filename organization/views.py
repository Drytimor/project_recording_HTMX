...
from organization.mixins import CustomMixin
...
# CRUD Employee
class EmployeeCreate(CustomMixin, TemplateResponseMixin, FormMixin, View):
...
class EmployeesCreateForm(CustomMixin, TemplateResponseMixin, FormMixin, View):
...
class EmployeesList(CustomMixin, TemplateResponseMixin, ContextMixin, View):
...
class EmployeeProfile(CustomMixin, TemplateResponseMixin, ContextMixin, View):
...
# CRUD Event
class EventsCreate(CustomMixin, TemplateResponseMixin, FormMixin, View):
...
class EventCreateForm(CustomMixin, TemplateResponseMixin, FormMixin, View):
...
class EventsList(CustomMixin, TemplateResponseMixin, ContextMixin, View):
...
class EventProfile(CustomMixin, TemplateResponseMixin, FormMixin, View):
